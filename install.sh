...
# Installing fonts
mkdir -p $HOME/.fonts
ln -sf "$(readlink -e "./fonts/Inconsolata Bold for Powerline.ttf")" \
  "$HOME/.fonts/Inconsolata Bold for Powerline.otf"
ln -sf "$(readlink -e "./fonts/Inconsolata for Powerline.otf")" \
  "$HOME/.fonts/Inconsolata for Powerline.otf"
fc-cache -fv
